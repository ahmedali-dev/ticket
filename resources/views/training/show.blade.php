  ...
  <div class="shell">
      ...
      <div class="sidebar-scroll">
        ...
        <div class="sidebar-search">
          <div class="search-box">
            ...
            <input id="moduleSearch" type="text" data-en-ph="Search modules..." data-ar-ph="ابحث في الوحدات..."
        ...
        <nav id="sectionsWrap">
          @foreach ($training->module as $module)
            <div class="section open">
              ...
              <div class="module-list"><button class="module"><span class="module-status done"><svg viewBox="0 0 24 24"
                      fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                      width="11" height="11">
                      <polyline points="20 6 9 17 4 12"></polyline>
                    </svg></span>
                  <div class="module-body">
                    <div class="module-title">What is Visual Design?</div>
                    <div class="module-meta">8:12</div>
                  </div>
                </button><button class="module active"><span class="module-status todo"></span>
                  <div class="module-body">
                    <div class="module-title">Intro to Visual Hierarchy</div>
                    <div class="module-meta">21:40</div>
                  </div>
                </button><button class="module"><span class="module-status todo"></span>
                  <div class="module-body">
                    <div class="module-title">Grid Systems &amp; Alignment</div>
                    <div class="module-meta">10:05</div>
                  </div>
                </button></div>
            </div>
          @endforeach
          ...
          <div class="section">
            ...
            <div class="module-list"><button class="module"><span class="module-status todo"></span>
                <div class="module-body">
                  <div class="module-title">Color Theory Basics</div>
                  <div class="module-meta">9:30</div>
                </div>
              </button><button class="module locked" disabled=""><span class="module-status locked-icon"><svg
          ...
          <div class="section">
            ...
            <div class="module-list"><button class="module locked" disabled=""><span
                  class="module-status locked-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor"
    ...
    <main class="main">
      <div class="breadcrumb" id="breadcrumb">
        ...
        <span class="sep">/</span>
        <a href="#" data-en="UX/UI Design Foundations" data-ar="أساسيات تصميم واجهات وتجربة المستخدم">UX/UI Design
          Foundations</a>
        <span class="sep">/</span>
        ...
        <div class="player-controls">
          <div class="progress-row">
            ...
            <div class="seek-wrap" id="seekWrap">
              ...
              <div class="seek-chapters" id="seekChapters">
                <div class="chapter-tick" style="inset-inline-start: 58%;"></div>
                <div class="chapter-tick" style="inset-inline-start: 94%;"></div>
              </div>
              <div class="seek-tooltip" id="seekTooltip" style="inset-inline-start: 14px;">
                <div class="seek-tooltip-thumb"><svg viewBox="0 0 24 24" fill="currentColor">
                    <polygon points="7 4 20 12 7 20 7 4"></polygon>
                  </svg></div>
          ...
          <div class="controls-row">
            <button class="ctl-btn" id="playBtn" aria-label="Play/Pause">
              <svg class="playIcon" viewBox="0 0 24 24" fill="currentColor">
                <polygon points="7 4 20 12 7 20 7 4"></polygon>
              </svg>
              <svg class="pauseIcon" viewBox="0 0 24 24" fill="currentColor" style="display:none">
            ...
            <div class="volume-wrap">
              <button class="ctl-btn" id="muteBtn" aria-label="Mute">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                  ...
                  <polygon points="4 9 8 9 12 5 12 19 8 15 4 15 4 9"></polygon>
      ...
      <div class="lesson-head">
        <div>
          ...
          <p class="lesson-desc" id="lessonDesc">Learn how spacing, scale, and contrast guide the eye through a screen,
            and practice building a clear reading order for a mobile app layout.</p>
        </div>
      ...
      <div class="info-row">
        <div class="info-pill">
          <span class="pill-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2">
        ...
        <div class="info-pill">
          <span class="pill-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2">
              ...
              <path d="M5 20c1.2-3.6 4-5.5 7-5.5s5.8 1.9 7 5.5"></path>
            </svg></span>
          <span><span class="pill-label" data-en="Instructor" data-ar="المدرّب">Instructor</span><b
              data-en="Laila Haddad" data-ar="ليلى حداد">Laila Haddad</b></span>
        </div>
        <div class="info-pill">
          <span class="pill-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2">
          ...
          <span><span class="pill-label" data-en="Published" data-ar="تاريخ النشر">Published</span><b
              data-en="June 14, 2026" data-ar="14 يونيو 2026">June 14, 2026</b></span>
        </div>
      </div>
        ...
        <div class="comment-form">
          ...
          <div style="flex:1">
            <textarea id="commentInput" data-en-ph="Ask a question or share a thought..."
              data-ar-ph="اطرح سؤالاً أو شارك فكرة..." placeholder="Ask a question or share a thought..."></textarea>
        ...
        <div id="commentsList">
          <div class="comment" data-id="c1">
            ...
            <div class="comment-body">
              ...
              <p class="comment-text">The 60-30-10 tip finally made hierarchy click for me. Using it on my portfolio
                redesign now.</p>
              ...
              <div class="replies" id="replies-c1">
                ...
                <div class="comment" data-id="c1r1">
                  ...
                  <div class="comment-body">
                    ...
                    <p class="comment-text">Love hearing that — post a screenshot in the community tab if you'd like
                      feedback!</p>
                    <div class="comment-actions">
