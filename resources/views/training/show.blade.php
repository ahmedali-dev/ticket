                ...
                <nav id="sectionsWrap">
                    @foreach ($training->module as $m)
                                        ...
                                        <div
                                            ...
                                            <a class="section-head flex-1 rounded-lg" href="{{ route('training.module_show', [
                            'training' => $training,
                            'module' => $m,
                        ]) }}">
                                            ...
                                            @if (auth()->user()->type == 'admin')
                                                ...
                                                <form action="{{ route('training.destroy', $training) }}" method="POST"
                                                    onsubmit="return confirm('Delete this training? This cannot be undone.')">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit"
        ...
        <main class="main">
            ...
            @if(!empty($module))
                ...
                <div class="player" id="player">
                    ...
                    @else
                        <div>
                            <video class="rounded-lg" id="my-video" controls
                                src="{{ Storage::url($module->media->path) }}"></video>
                        </div>
                    @endif
                                ...
                                <dialog id="chapter-dialog"
                                    ...
                                    <form class="w-full p-4" id="chapter-form" method="dialog">
                                        ...
                                        <div class="flex flex-col gap-3 my-4">
                                            ...
                                            <input class="rounded border-2 border-blue-400 px-3 py-3 w-full" name="title"
                                                id="chapter-title" placeholder="Enter the Chapter Title" value="" type="text" />
                                        </div>
                                        ...
                                        <div class="flex flex-col gap-3 my-4">
                                            ...
                                            <input class="rounded border-2 border-blue-400 px-3 py-3 w-full" name="date"
                                                id="chapter-date" placeholder="e.g. 12:34" value="" type="text"
                                                pattern="^\d{1,3}:\d{1,2}$" title="Format: minutes:seconds, e.g. 12:34" />
                                        </div>

                                        <div class="flex items-center justify-around gap-2">
                                            <button commandfor="chapter-dialog" command="close" id="chapter-close" type="button"
                                                class="flex justify-center items-center w-[calc(100%-20px)] mx-auto my-4 px-4 rounded-md text-md h-[3rem] bg-black text-white disabled:opacity-50 disabled:cursor-not-allowed">
                                                Close
                                            </button>
