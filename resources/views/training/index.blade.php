                        ...
                        <a href="{{ route('training.show', $training) }}">
                            <div
                                ...
                                @if(isset($training->media[0]->path))
                                    ...
                                    <img class="w-full h-full object-cover" src="{{Storage::url($training->media[0]->path)}}"
                            ...
                            <div class="p-5 flex flex-col gap-3 flex-1">
                                ...
                                {{-- <p class="text-slate-500 text-[13.5px] clamp-2">Learn the core principles of user
                                    experience--}}
                                ...
                                <div
                                    ...
                                    <span class="flex items-center gap-1">📘 {{ $training->module->count() }} Modules</span>
                                    <span class="flex items-center gap-1">🗓️
                                        {{$training->created_at->format('y/m/d')}}</span>
                                </div>
                            </div>
                        </a>
